...
function AddMovie() {
    ...
    const validate=async(e)=>{
        ...
        if(!movieType.trim()) newErrors.movieType="Movie Type is required";
        if(!movieLink.trim()) newErrors.movieLink="Movie Link is required";
        if(!movieTrailer.trim()) newErrors.movieTrailer="Movie Trailer is required";
        if(!slider) newErrors.slider="Slider is required";
        setErrors(newErrors);
    }
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mt-1 rounded-md shadow-sm">
                                        <input
                                            ...
                                            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                        />
                                        {errors.movieLink && <p className="text-red-500 text-sm mt-2">{errors.movieLink}</p>}
                                    </div>
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="mt-1 rounded-md shadow-sm">
                                        <input
                                            ...
                                            className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                                        />
                                        {errors.movieTrailer && <p className="text-red-500 text-sm mt-2">{errors.movieTrailer}</p>}
                                    </div>
                                </div>
                                <div className='mt-6'>
                                    ...
                                    {errors.slider && <p className="text-red-500 text-sm mt-2">{errors.slider}</p>}
                                </div>
                                <div className='mt-6'>
                                    ...
                                    {errors.movieType && <p className="text-red-500 text-sm mt-2">{errors.movieType}</p>}
                                </div>
                                <div className="mt-6">
